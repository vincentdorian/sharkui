...
import { SharkButton, buttonVariants } from "@/components/ui/button";
...
const links: { name: string; href: string }[] = [
  ...
  { name: "Github", href: "https://github.com/vincentdorian/sharkui" },
  { name: "Roadmap", href: "#" },
];
  ...
  <div class="relative flex min-h-screen flex-col">
    ...
    >
      <div class="container flex h-14 items-center">
        <div class="mr-4 hidden w-full md:flex">
          <NuxtLink class="mr-6 flex items-center space-x-2" href="/">
            <AppIcon class="h-6 w-6" />
            <span class="hidden font-bold sm:inline-block"> sharkui </span>
          </NuxtLink>
        ...
        <div class="w-full flex md:hidden">
          <SharkSheet>
            <SharkSheetTrigger :class="buttonVariants({ variant: 'ghost' })">
              <PanelLeftOpen class="h-6 w-6" />
            </SharkSheetTrigger>
            <Teleport to="body">
              <SharkSheetOverlay />
              <SharkSheetContent position="left" size="xl">
                <SharkSheetHeader>
                  <NuxtLink class="mr-6 flex items-center space-x-2" href="/">
                    <AppIcon class="h-6 w-6" />
                    <span class="font-bold sm:inline-block"> sharkui </span>
                  </NuxtLink>
                </SharkSheetHeader>
                <div>
                  <ul class="flex flex-col space-y-3 ml-8 mt-6">
                    <li v-for="link in links" :key="link.href">
                      <NuxtLink
                        :href="link.href"
                        :class="
                          cn('flex items-center space-x-2', {
                            'text-muted-foreground': $route.path !== link.href,
                ...
                <div class="w-full flex flex-col space-y-3 mt-8 ml-8">
                  <div
                    ...
                    >
                      ...
                      >
                        <NuxtLink
                          ...
                          :class="
                            cn(
                              'group flex w-full items-center rounded-md border border-transparent py-1',
                              {
    ...
    <footer class="-mb-20 border-t py-6 md:py-0">
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            . Built by {{ " " }}
            <a
              href="https://twitter.com/ctrlfdori"
              target="_blank"
              rel="noreferrer"
              class="font-medium underline underline-offset-4"
            >
