...
<template>
  <NuxtLayout name="default">
    <section class="container">
      <div
        class="flex max-w-[980px] flex-col items-start justify-start gap-2 px-4 pt-8 md:pt-12"
      >
        <h1
          class="text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:text-6xl lg:leading-[1.1]"
        >
          Customizable components for Vue.
        </h1>
        <p class="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
          Finally you can use the popular component library shadcn/ui with
          Vue.js. Copy and paste or install via CLI. Supporting Laravel, Nuxt,
          and more.
        </p>
        ...
        <div class="mt-2 flex flex-col items-center gap-4 md:flex-row">
          ...
          >
            <svg viewBox="0 0 438.549 438.549" class="mr-2 h-5 w-5">
              <path
                fill="currentColor"
