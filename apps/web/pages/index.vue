...
<template>
  <NuxtLayout name="default">
    ...
    <div class="flex max-w-[980px] flex-col items-start gap-2 px-4 pt-8 md:pt-12 justify-start">
      ...
      >
        First class components for Vue.
      </h1>
      <p class="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
        Finally you can use the popular component library shadcn/ui with Vue.js.
        Copy and paste or install via CLI. Supporting Laravel, Nuxt, and more.
      </p>
      ...
      <div class="flex flex-col items-center gap-4 md:flex-row md:gap-2">
        ...
        >
          <svg viewBox="0 0 438.549 438.549" class="h-5 w-5 mr-2">
            <path
              fill="currentColor"
